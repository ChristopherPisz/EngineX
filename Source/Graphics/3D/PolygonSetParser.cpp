                                 ...
                                 const bool generateTangentData)
{
   ...
   if( file.fail() )
   {
      exception.m_msg = std::string("Failed to open file: ") + filepath;
      throw exception;
   }
...
void PolygonSetParser::ParseMaterial(std::ifstream & file)
{
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing material type";
      throw exception;
   }
   ...
   {
      exception.m_msg = "Unknown material type";
      throw exception;
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing shader type";
      throw exception;
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing whether or not the ambient channel is mapped";
      throw exception;
   }

   if( ambientMapped )
   {
      // Get the texture file name the ambient color is mapped to
      char oneByte = 0x01;
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing filename of texture ambient is mapped to";
         throw exception;
      }
   }
   else
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing ambient color";
         throw exception;
      }
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing whether or not the emissive channel is mapped";
      throw exception;
   }
   ...
   if( emissiveMapped )
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing filename of texture emissive is mapped to";
         throw exception;
      }
   }
   else
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing emissive color";
         throw exception;
      }
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing whether or not the diffuse channel is mapped";
      throw exception;
   }
   ...
   if( diffuseMapped )
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing filename of texture diffuse is mapped to";
         throw exception;
      }
   }
   else
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing diffuse color";
         throw exception;
      }
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing whether or not the specular channel is mapped";
      throw exception;
   }
   ...
   if( specularMapped )
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing filename of texture specular is mapped to";
         throw exception;
      }
   }
   else
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing specular color";
         throw exception;
      }
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing specular exponent";
      throw exception;
   }
...
void PolygonSetParser::ParseVertices(std::ifstream & file)
{
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing number of vertices to read";
      throw exception;
   }
   ...
   if( !file )
   {
      exception.m_msg = "Error parsing number of UVs to read";
      throw exception;
   }
   ...
   for(unsigned i = 0; i < numVertices; ++i)
   {
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing vertex position";
         throw exception;
      }
      ...
      if( !file )
      {
         exception.m_msg = "Error parsing vertex normal";
         throw exception;
      }
      ...
      for(unsigned j = 0; j < numUVSets; ++j)
      {
         ...
         if( !file )
         {
            exception.m_msg = "Error parsing vertex UV";
            throw exception;
         }
