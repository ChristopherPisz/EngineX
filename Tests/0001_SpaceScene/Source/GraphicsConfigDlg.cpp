   ...
   m_displayMode(result)
{
   ...
   {
      throw BaseException("Unable to initialize windows common controls 6 or later.",
                          "GraphicsConfigDlg::GraphicsConfigDlg(DisplayMode & result)",
                          "GraphicsConfigDlg.cpp");
   }
...
{
   return BaseModalDialog::Init(instance, MAKEINTRESOURCE(IDD_GRAPHICS_CONFIG), NULL);
}
...
void GraphicsConfigDlg::InitComponents()
{
   ...
   {
      throw BaseException("Unable to get handles to one or more dialog controls",
                          "void GraphicsConfigDlg::InitComponents()",
                          "GraphicsConfigDlg.cpp");
   }
